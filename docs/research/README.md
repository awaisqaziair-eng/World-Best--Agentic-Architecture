...
| [R5 — Stack bake-off](05-stack-bakeoff.md) | Which prebuilt stack is the best foundation, on the same tasks, model and verifiers? | Measured: pass rates indistinguishable (23–26/28); cost spreads 2.5×; v2 vs Coder 50/56 each (p = 1.00) |
